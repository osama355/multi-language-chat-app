        ...
        child: Obx(()=>
         Column(
            ...
            const  Center(
              ...
              Expanded(
                child: StreamBuilder(
                  stream: Firebaseservice.getallmessage(docid: controller.chatDocId.toString()),
                  builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot){
                   ...
                   return  const Center(
                      ...
                      return Center(
                        child: "Send a Message".text.color(Colors.grey.withOpacity(0.7)).make(),
                      );
                ...
                ).box.height(90).padding(const EdgeInsets.all(12)).margin(const EdgeInsets.only(bottom: 2)).make()
            ],
          ),
        ),
      ),
